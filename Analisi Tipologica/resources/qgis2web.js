...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3003',
            //extent: [1602390.210000, 4835824.661713, 1603487.600000, 4837103.470000],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([1601600.447118, 4835458.945244, 1603997.636375, 4836787.457472], map.getSize());
